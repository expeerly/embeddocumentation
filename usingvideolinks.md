...
3. [Embedding with Mux](#3-embedding-with-mux)
   ...
   - [3.5 Embedding Mux Videos in Shopify with simple Mux Streaming Links](#35-embedding-mux-videos-in-shopify-with-simple-mp4-mux-streaming-links)
   - [3.6 Embedding Mux Videos in Shopify with Mux Player - RECOMMENDED](#36-embedding-mux-videos-in-shopify-with-mux-player---recommended)
