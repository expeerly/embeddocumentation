...
- [WordPress / WooCommerce (Custom Plugin)](#wordpress--woocommerce-custom-plugin)
  ...
  - [Configure the widget](#2-configure-the-widget)
  - [Optional: manual placement with shortcode](#3-optional-manual-placement-with-shortcode)
  - [Optional: disable global auto-load](#4-optional-disable-global-auto-load)
